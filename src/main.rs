...
fn main() {
    App::new()
        ...
        .add_systems(Startup, spawn_sentry.after(setup))
        ...
        .add_systems(Update, sentry_follow_system)
        .add_systems(Update, sentry_explosion_system)
        .add_systems(Update, update_explosion_particles)
        .add_systems(Update, update_explosion_light)
        .add_systems(Update, sentry_respawn_system)
        .add_systems(Update, sentry_light_system)
        .add_systems(Update, periodic_sentry_spawn)
